...
exports.CATEGORY_LOOKUP_BY_NAME = exports.CATEGORY_CATALOG = void 0;
const slugify = (value) => value
    ...
    .replace(/-+/g, "-")
    .replace(/^-|-$/g, "");
const makeSubcategories = (majorKey, names) => names.map((name) => ({ key: `${majorKey}.${slugify(name)}`, name }));
exports.CATEGORY_CATALOG = [
    {
        key: "income",
        name: "Income",
...
exports.CATEGORY_LOOKUP_BY_NAME = exports.CATEGORY_CATALOG.reduce((acc, major) => {
